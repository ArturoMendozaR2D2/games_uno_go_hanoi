...
*/
		...
		while (g==0){
			...
			if(ch==1 && t==1){
				mostrar(Xn,Xc,p1);
				cout<<"INGRESE LA POSICIÃ“N DE LA CARTA EN LA BARAJA "<<"(1 al "<<p1+1<<")";
				cin>>ci;
				while(ci<1 || ci>p1+1){
					cout<<"INGRESE UNA POSICION VÃLIDA: "<<endl;
					cin>>ci;
				}
				...
				mostrar(Yn,Yc,p2);
                                cout<<"INGRESE LA POSICIÃ“N DE LA CARTA EN LA BARAJA "<<"(1 al "<<p2+1<<")";
                                cin>>ci;
                                while(ci<1 || ci>p2+1){
                                        cout<<"INGRESE UNA POSICION VÃLIDA: "<<endl;
                                        cin>>ci;
				...
				mostrar(Zn,Zc,p3);
                                cout<<"INGRESE LA POSICIÃ“N DE LA CARTA EN LA BARAJA "<<"(1 al "<<p3+1<<")";
                                cin>>ci;
                                while(ci<1 || ci>p3+1){
                                        cout<<"INGRESE UNA POSICION VÃLIDA: "<<endl;
                                        cin>>ci;
	...
	void idci(int num, int col){
		if(num==10){
			...
			if(col==1){
                                cout<<"   #####"<<endl<<"  #"<<"Ã˜ "<<" #"<<endl<<" #  "<<"R#"<<endl<<"#####"<<endl; //R = red
                        }
                        else if(col==2){
                                cout<<"   #####"<<endl<<"  #"<<"Ã˜ "<<" #"<<endl<<" #  "<<"B#"<<endl<<"#####"<<endl; //B = blue
                        }
                        else if(col==3){
                                cout<<"   #####"<<endl<<"  #"<<"Ã˜ "<<" #"<<endl<<" #  "<<"G#"<<endl<<"#####"<<endl; //G = green
                        }
                        else{
                                cout<<"   #####"<<endl<<"  #"<<"Ã˜ "<<" #"<<endl<<" #  "<<"Y#"<<endl<<"#####"<<endl; //Y = yellow
                        }
...
class Go{
			...
			int s=0;
	                while(s==0){
        	                ...
        	                if (j ==1 && dat==1){
                	                ...
                	                cout<<"POSICIÃ“N NO VALIDA, VUELVA A INTENTARLO"<<endl;
                        	        s=0;
                        	}
          		}
    ...
    void compmuerte(int a[][19], int b[][19]){
	    	for (int i=0;i<19;i++){
	    	    for(int j=0;j<19;j++){
	    	        //para negras
	    	        int br=0;
	...
	int comprob(int a[363], int b[363],int f, int c){
...
void verificar(int n,int t2[],int t3[])
{
	int c2=0,c3=0;
	for (int i=3;i<=n;i++)
	{
...
int main(){
		...
		system("clear");
                ...
                int n;
		system("clear");
		cout<<"Â¿Con cuÃ¡ntos discos desea jugar? ";
	        cin>>n;
		Hanoi Partida;
		Partida.juego(n);
	}
